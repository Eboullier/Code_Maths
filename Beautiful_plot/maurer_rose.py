    ...
    def construct(self):
        ...
        for P in [[3,29,2],[3,41,3],[3,23,4],[3,67,5],[3,53,6],[3,23,7],[3,83,8],[3,31,9]]:
            ARose = ParametricFunction(
                lambda u: (P[0] * math.sin(P[2]*u)*math.cos(u), P[0] * math.sin(P[2]*u)*math.sin(u), 0), t_range = [0,(1+(P[2]+1)%2) * PI])
        ...
        Title=Tex("Maurer Roses: Connect 360 Points on a Rose Curve", font_size=100)
